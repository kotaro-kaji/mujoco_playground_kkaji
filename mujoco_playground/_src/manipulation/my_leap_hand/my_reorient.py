...
from mujoco_playground._src.manipulation.my_leap_hand import base as my_leap_hand_base
from mujoco_playground._src.manipulation.my_leap_hand import my_leap_hand_constants as consts
...
class MyCubeReorient(my_leap_hand_base.MyLeapHandEnv):
  ...
  def _get_obs(
    ...
    rand_quat = my_leap_hand_base.uniform_quat(key1)
...
def domain_randomize(model: mjx.Model, rng: jax.Array):
  mj_model = MyCubeReorient().mj_model
