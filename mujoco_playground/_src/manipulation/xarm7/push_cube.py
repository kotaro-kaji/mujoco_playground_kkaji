"""XArm7 push cube environment (Stage 0).

Behavior matches PandaRobotiqPushCube; XML remains Panda scene for wiring.
"""
...
from mujoco_playground._src.manipulation.xarm7 import xarm7_base
...
def default_config():
  """Returns default config (same as PandaRobotiqPushCube)."""
...
class XArm7PushCube(xarm7_base.XArm7Base):
  """Environment for pushing a cube (Stage 0; Panda XML)."""

  def __init__(
      self,
      config: config_dict.ConfigDict = default_config(),
      config_overrides: Optional[Dict[str, Union[str, int, list[Any]]]] = None,
      sample_orientation: bool = False,  # kept for parity
  ):
    super().__init__(
        config,
